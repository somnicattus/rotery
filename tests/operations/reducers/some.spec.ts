import { pipe, some } from '../../../src/index.js';
...
describe('find', () => {
    describe('sync', () => {
        ...
        )('should return undefined with a negative target $type through pipe.', ({ data }) => {
    ...
    describe('async', () => {
        ...
        )('should return undefined with a negative target $type through pipe.', async ({
            data,
        }) => {
        ...
        it.each(
            testAsyncValues(negativeTarget),
        )('should return undefined with a negative target $type by async operation through pipe.', async ({
            data,
        }) => {
