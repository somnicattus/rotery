import { find, pipe } from '../../../src/index.js';
...
describe('some', () => {
    describe('sync', () => {
        ...
        )('should return value with a positive target $type.', ({ data }) => {
    ...
    describe('async', () => {
        ...
        )('should return value with a positive target $type.', async ({ data }) => {
        ...
        it.each(
            testAsyncValues(positiveTarget),
        )('should return value with a positive target $type by async operation.', async ({
            data,
        }) => {
