import { awaitAll, flatMap, pipe, serialize } from '../../../src/index.js';
...
describe('flatMap', () => {
    describe('sync', () => {
        ...
        it.each(testSyncValues(values))('should flatMap $type into iterator through pipe.', ({
            data,
        }) => {
    ...
    describe('async', () => {
        it.each(testAsyncValues(values))('should flatMap $type into async iterator.', async ({
            data,
        }) => {
        ...
        )('should flatMap $type into async iterator through pipe.', async ({ data }) => {
        ...
        it.each(
            testAsyncValues(values),
        )('should flatMap $type into async iterator by async operation.', async ({ data }) => {
        ...
        it.each(
            testAsyncValues(values),
        )('should flatMap $type into async iterator through pipe by async operation.', async ({
            data,
        }) => {
        ...
        it.each(
            testAsyncValues(values),
        )('should flatMap $type into async iterator by async iterative operation.', async ({
            data,
        }) => {
