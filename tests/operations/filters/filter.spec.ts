import { awaitAll, filter, pipe } from '../../../src/index.js';
...
describe('filter', () => {
    ...
    describe('async', () => {
        ...
        it.each(testAsyncValues(values))('should filter $type by async operation.', async ({
            data,
        }) => {
        ...
        )('should filter $type through pipe by async operation.', async ({ data }) => {
