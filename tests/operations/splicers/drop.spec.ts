import { awaitAll, drop, pipe } from '../../../src/index.js';
...
describe('drop', () => {
    describe('sync', () => {
        ...
        it.each(testSyncValues(values))('should drop elements from $type through pipe.', ({
            data,
        }) => {
    ...
    describe('async', () => {
        ...
        it.each(testAsyncValues(values))('should drop elements from $type through pipe.', async ({
            data,
        }) => {
