import { awaitAll, concat, pipe, serialize } from '../../../src/index.js';
...
describe('concat', () => {
    describe('sync', () => {
        ...
        it.each(testSyncValues(values))('should concatenate $type with an array through pipe.', ({
            data,
        }) => {
    ...
    describe('async', () => {
        it.each(testAsyncValues(values))('should concatenate $type with an array.', async ({
            data,
        }) => {
        ...
        )('should concatenate $type with an array through pipe.', async ({ data }) => {
        ...
        it.each(
            testAsyncValues(values),
        )('should concatenate $type with an async iterator.', async ({ data }) => {
