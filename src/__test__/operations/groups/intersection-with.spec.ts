import { awaitAll, intersectionWith, pipe } from '../../../index.js';
...
describe('intersectionWith', () => {
    ...
    describe('async', () => {
        ...
        it.each(testAsyncValues(values1))(
            'should get intersection of $type with array with async equals.',
            async ({ data }) => {
        ...
        it.each(testAsyncValues(values1))(
            'should get intersection of $type with array with async equals through pipe.',
            async ({ data }) => {
        ...
        it.each(testAsyncValues(values1))(
            'should get intersection of $type with set with async equals.',
            async ({ data }) => {
        ...
        it.each(testAsyncValues(values1))(
            'should get intersection of $type with set with async equals through pipe.',
            async ({ data }) => {
