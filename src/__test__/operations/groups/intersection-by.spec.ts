import { awaitAll, intersectionBy, pipe } from '../../../index.js';
...
describe('intersectionBy', () => {
    ...
    describe('async', () => {
        ...
        it.each(testAsyncValues(values1))(
            'should get intersection of $type with array by async key.',
            async ({ data }) => {
        ...
        it.each(testAsyncValues(values1))(
            'should get intersection of $type with array by async key through pipe.',
            async ({ data }) => {
        ...
        it.each(testAsyncValues(values1))(
            'should get intersection of $type with set by async key.',
            async ({ data }) => {
        ...
        it.each(testAsyncValues(values1))(
            'should get intersection of $type with set by async key through pipe.',
            async ({ data }) => {
