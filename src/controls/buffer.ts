 ...
 *
 * If the input generates promises, the promises are executed in parallel and throttled.
 */
...
/**
 * The promises generated by the given generator are executed in parallel and throttled.
